...
function PizzaEmptyItem({pizza, totalCount, totalPrice, onRemoveCartItem, onMinusCartItem, onPlusCartItem}) {

    const handleMinusItem = () => {
        onMinusCartItem(pizza.id);
    }

    const handlePlusItem = () => {
        onPlusCartItem(pizza.id);
    }

    const handleRemoveCartItem = () => {
        onRemoveCartItem(pizza.id)
    }
