...
import PizzaEmptyItem from '../components/pizzaEmptyItem/PizzaEmptyItem';
                ...
                <div className="container container--cart">
                    ...
                    <div className="cart__bottom ">
                        <div className="cart__bottom-details">
                            <span> Всего пицц: <b>{totalCount && totalCount} шт.</b> </span>
                            <span> Сумма заказа: <b>{totalPrice && totalPrice} ₽</b> </span>
                        </div>
                        <div className="cart__bottom-buttons">
                            <Link exect="true" to="/" className="button button--outline button--add go-back-btn">
            ...
            <div className="content">
                <div className="container container--cart">
                    <div className="cart cart--empty">
                        ...
                        <Link exect='true' to="/" className="button button--black">
                        <span>Вернуться назад</span>
                        </Link>
                    </div>
                </div>
